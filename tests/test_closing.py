...
def test_channel_lease_post_expiry(node_factory, bitcoind, chainparams):
    ...
    channel_mvts_1 = [
        {'type': 'chain_mvt', 'credit_msat': 506272000, 'debit_msat': 0, 'tags': ['channel_open', 'opener', 'leased']},
        {'type': 'channel_mvt', 'credit_msat': 0, 'debit_msat': 6272000, 'tags': ['lease_fee'], 'fees_msat': '0msat'},
    ...
    channel_mvts_2 = [
        ...
        {'type': 'channel_mvt', 'credit_msat': 6272000, 'debit_msat': 0, 'tags': ['lease_fee'], 'fees_msat': '0msat'},
        {'type': 'channel_mvt', 'credit_msat': 10000, 'debit_msat': 0, 'tags': ['invoice'], 'fees_msat': '0msat'},
        {'type': 'chain_mvt', 'credit_msat': 0, 'debit_msat': 506282000, 'tags': ['channel_close']},
    ]
...
def test_onchain_slow_anchor(node_factory, bitcoind):
    ...
    # A unified signature adds a sighash byte, so the anchor spend is 1 weight heavier.
    l1.daemon.wait_for_log(r"Anchorspend for local commit tx fee (9377|9369|9384)sat \(w=72[23]\), commit_tx fee 1735sat \(w=76[78]\): package feerate 7457 perkw")
